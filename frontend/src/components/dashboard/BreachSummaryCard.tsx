  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
      <div className="flex items-center gap-3">
        <div className={`p-2.5 rounded-full transition-all duration-300 ${breachedCount > 0 ? 'bg-danger/10 text-danger shadow-lg shadow-danger/10' : hasResults ? 'bg-success/10 text-success shadow-lg shadow-success/10' : 'bg-surface-hover text-text-muted'}`}>
          {breachedCount > 0 ? (
