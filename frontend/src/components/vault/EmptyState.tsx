...
export default function EmptyState({ onAdd }: Props) {
  return (
    <div className="flex flex-col items-center justify-center py-24 text-center">
      ...
      <h3 className="text-base font-medium text-zinc-300 mb-1">No entries yet</h3>
      <p className="text-sm text-zinc-600">Add your first password or note to get started.</p>
    </div>
  );
}